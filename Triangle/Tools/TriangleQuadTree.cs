...
namespace TriangleNet.Tools
{
    ...
    public class TriangleQuadTree
    {
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public double QueryHieght(double x, double y)
        {
            ITriangle triangle = Query(x, y);
            if (null == triangle) return -100;
            Point pt = new Point(x, y);
            Interpolation.InterpolateZ(pt, triangle);

            Vertex pt1 = triangle.GetVertex(0);
            Vertex pt2 = triangle.GetVertex(1);
            Vertex pt3 = triangle.GetVertex(2);

            double d = pt1.x * pt2.y*pt3.z + pt2.x *pt3.y * pt1.z + pt3.x * pt1.y * pt2.z - pt3.x *pt2.y * pt1.z - pt1.x * pt3.y *pt2.z - pt2.x * pt1.y * pt3.z;
            double a = pt1.y * pt2.z +pt2.y * pt3.z + pt3.y * pt1.z -pt3.y * pt2.z -pt1.y * pt3.z -pt2.y * pt1.z;
            double b = pt1.x * pt2.z + pt2.x * pt3.z + pt3.x * pt1.z -pt3.x * pt2.z - pt1.x * pt3.z - pt2.x * pt1.z;
            double c = pt1.x * pt2.y +pt2.x * pt3.y + pt3.x * pt1.y-pt3.x * pt2.y -pt1.x * pt3.y-pt2.x * pt1.y;

            pt.z = (d / c - a / c * x + b / c * y);
